...
let SUB_PATH = process.env.A || '';       // 订阅路径
...
let ARGO_DOMAIN = process.env.B || '';          // 固定隧道域名,留空即启用临时隧道
let ARGO_AUTH = process.env.C || '';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
